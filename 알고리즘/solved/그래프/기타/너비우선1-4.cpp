...
int Rank[100001];		// 노드가 최초로 방문된 순서
int dist[100001];		// 노드까지 최단 거리 (이동 횟수, 노드의 level)
int cost[100001];		// 노드까지 최단 비용 (누적 가중치)
int vist[100001];		// 노드의 방문 여부나, 재방문 횟수-1
...
// 탐색 편입 후보의 선배제 ㅡ 비정상적인 노드
// 탐색 편입 후보의 선배제 ㅡ 특별히 탈락되는 노드
